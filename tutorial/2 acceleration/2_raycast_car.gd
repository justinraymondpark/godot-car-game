extends RigidBody3D
const _2RaycastWheel = preload("uid://cl7xr5gi8kf32")

@export var wheels: Array[_2RaycastWheel]
...
func _do_single_wheel_acceleration(ray: _2RaycastWheel) -> void:
...
func _do_single_wheel_suspension(ray: _2RaycastWheel) -> void:
	if ray.is_colliding():
