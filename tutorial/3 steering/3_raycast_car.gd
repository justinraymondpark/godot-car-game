extends RigidBody3D
const _3RaycastWheel = preload("uid://dhyalxtec37l8")

@export var wheels: Array[_3RaycastWheel]
...
func _do_single_wheel_traction(ray: _3RaycastWheel, idx: int) -> void:
...
func _do_single_wheel_acceleration(ray: _3RaycastWheel) -> void:
...
func _do_single_wheel_suspension(ray: _3RaycastWheel) -> void:
	if ray.is_colliding():
